...
<br>
<div class="container">
<h4>Notice:Here are the products available.To buy the product you must register or login your account</h4><br><br>
  <header id="header">
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top" style="width: 1161px; height: 54px; top: 10px;">
      <a href="shop.php" class="navbar-brand">
        <h3 class="px-5"><i class="fa fa-shopping-basket"></i>Products</h3>
      </a>
...
<div class="row text-center home-img py-4 shop">
        ...
        if($result->num_rows>0){
          ...
          <form action="bill.php">
            <div class="">
            <img src="images/<?php echo $row['product_image'] ?>"  class="img-fluid card-img-top" style="height: 147px;">
            <h5><?php echo $row['product_name'];?></h5>
            <p class="card-title"><?php echo $row['description'];?></p>
            
            
            <button type="button" class="btn btn-primary"><h5><?php echo "Rs " .$row['product_price'];?></h5></button>
