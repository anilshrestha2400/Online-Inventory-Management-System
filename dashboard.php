...
<body>	
    ...
    <a class="nav-link" href="#" style="font-size: 25px; color: white;">Inventory <small><small><small>Admin Area</small></small></small></a>
    <label for="check">
	...
	<div class="sidebar">
		<center>
			<img src="images/admin.jpg" class="image" style="width: 119px;"><h4 style="margin-top: -36px; font-size: 20px;">Admin</h4>
		</center>
		<a href="#"><span style="font-size: 22px;">Dashboard</span></a>
		<a href="add.php"><span style="font-size: 22px;">Add Product</span></a>
	</div>
    ...
    ?>
		...
		<tr class="text-center">
			...
			<td> <a href="update.php?id=<?php echo $row['id']; ?>&erp=<?php echo $row['product_image']; ?>&ert=<?php echo $row['description']; ?>&erx=<?php echo $row['product_name']; ?>&erz=<?php echo $row['product_price']; ?>"><i class="fa fa-edit"></i></a></td>
			<td> <a href="delete.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" onclick="return confirm('Are you sure want to delete')"></i></a></td>
		</tr>
		<?php 
			}
		 ?>
