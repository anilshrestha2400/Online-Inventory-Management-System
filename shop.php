...
<div class="row text-center home-img py-4 shop">
        ...
        if($result->num_rows>0){
          ...
          <form action="bill.php">
            ...
            <button type="submit" class="btn btn-warning my-3 " name="add" ><a href="bill.php?i=<?php echo $row['product_image']; ?>&n=<?php echo $row['product_name']; ?>&p=<?php echo $row['product_price']; ?>" style="text-decoration: none; color: black;">Buy</a><i class="fa fa-shopping-cart"></i></button>
