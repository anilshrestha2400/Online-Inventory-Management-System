 ...
 <body>
	...
	if(isset($_POST['btn'])){
		...
		if($image && $text && $text1 && $text2){
			$sql="INSERT INTO dash(product_image,description,product_name,product_price)
	...
	?>
 	<div class="col-lg-6 m-auto">
		...
		Product image: <input type="file" name="image" style="height: 45px;" required><span class="error"><?php echo $erp;?></span>
		Description: <input type="text" name="text" style="height: 75px;"><span class="error"><?php echo $ert;?></span><br>
		Product name: <input type="text" name="text1" style="height: 40px;"><span class="error"><?php echo $erx;?></span><br>
		Product price: <input type="text" name="text2" style="height: 40px;"><span class="error"><?php echo $erz;?></span><br>
