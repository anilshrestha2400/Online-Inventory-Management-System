    ...
    <div id="page">
      <table id="cart">
        ...
        <tbody>
          ...
          <tr class="productitm">
            <td><img src="<?php echo $i;?>" class="thumb"></td>
            <td><?php echo $n;?></td>
            <td><?php echo $p;?></td>
          ...
          <tr class="totalprice">
            ...
            <td >&nbsp;</td>
            <td><span class="thick"><?php echo $p;?></span></td>
          </tr>
          
        
          <tr class="checkoutrow">
            <td colspan="5" class="checkout"><button id="submitbtn" onclick="return confirm('Successfully checkout')">Checkout Now!</button></td>
          </tr>
        </tbody>
      </table>
    </div>
